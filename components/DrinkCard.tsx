...
export default function DrinkCard({ drink, showAdminControls = false, onEdit }: DrinkCardProps) {
  return (
    <div className="relative">
      ...
      {showAdminControls && (
        <button
          ...
          className="absolute right-3 top-3 z-10 flex h-9 w-9 items-center justify-center rounded-full border border-zinc-200 bg-white/90 text-sm text-zinc-900 shadow-sm backdrop-blur-sm transition hover:bg-white"
        >
          ✏️
        </button>
      )}
